					...
					<div id="header-left-section">
						...
						?>
							<div id="header-logo-image">
								...
								<a href="<?php echo esc_url( home_url( '/fdfj.php' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo esc_url(get_theme_mod('colormag_logo')); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>"></a>
...
<div class="breaking">
<div class="name"> এই মাত্র পাওয়া :</div>
<div class="title"><?php if (function_exists (ptmsshow)) ptmsshow(); ?></div>
