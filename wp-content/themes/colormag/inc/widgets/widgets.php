...
function colormag_widgets_init() {
   ...
   register_sidebar( array(
     ...
     // registering the Front Page: Content Middle Left Section Sidebar
   register_sidebar( array(
      'name'            => __( 'Front Page: Content Middle_2 Left Section', 'colormag' ),
      'id'              => 'colormag_front_page_content_middle_2_left_section',
      'description'     => __( 'Content Middle_2 Left Section', 'colormag' ),
      'before_widget'   => '<section id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</section>',
      'before_title'    => '<h3 class="widget-title"><span>',
      'after_title'     => '</span></h3>'
   ...
   // registering the Front Page: Content Middle Right Section Sidebar
   register_sidebar( array(
      'name'            => __( 'Front Page: Content Middle_2 Right Section', 'colormag' ),
      'id'              => 'colormag_front_page_content_middle_2_right_section',
      'description'     => __( 'Content Middle_2 Right Section', 'colormag' ),
      'before_widget'   => '<section id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</section>',
      'before_title'    => '<h3 class="widget-title"><span>',
      'after_title'     => '</span></h3>'
...
class colormag_featured_posts_slider_widget extends WP_Widget {
   ...
   function colormag_featured_posts_slider_widget() {
      ...
      parent::WP_Widget( false,$name= __( 'TG: Featured Category Slider', 'colormag' ),$widget_ops);
   }
...
class colormag_featured_posts_widget extends WP_Widget {
   ...
   function colormag_featured_posts_widget() {
      ...
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::WP_Widget( false,$name= __( 'TG: Featured Posts (Style 1)', 'colormag' ),$widget_ops);
   }
...
class colormag_featured_posts_vertical_widget extends WP_Widget {
   ...
   function colormag_featured_posts_vertical_widget() {
      ...
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::WP_Widget( false,$name= __( 'TG: Featured Posts (Style 2)', 'colormag' ),$widget_ops);
   }
...
class colormag_300x250_advertisement_widget extends WP_Widget {
   ...
   function colormag_300x250_advertisement_widget() {
      $widget_ops = array( 'classname' => 'widget_300x250_advertisement', 'description' => __( 'Add your 300x250 Advertisement here', 'colormag') );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::WP_Widget( false,$name= __( 'TG: 300x250 Advertisement', 'colormag' ),$widget_ops);
   }
...
class colormag_728x90_advertisement_widget extends WP_Widget {
   ...
   function colormag_728x90_advertisement_widget() {
      $widget_ops = array( 'classname' => 'widget_728x90_advertisement', 'description' => __( 'Add your 728x90 Advertisement here', 'colormag') );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::WP_Widget( false,$name= __( 'TG: 728x90 Advertisement', 'colormag' ),$widget_ops);
   }
...
class colormag_125x125_advertisement_widget extends WP_Widget {
   ...
   function colormag_125x125_advertisement_widget() {
      $widget_ops = array( 'classname' => 'widget_125x125_advertisement', 'description' => __( 'Add your 125x125 Advertisement here', 'colormag') );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::WP_Widget( false,$name= __( 'TG: 125x125 Advertisement', 'colormag' ),$widget_ops);
   }
