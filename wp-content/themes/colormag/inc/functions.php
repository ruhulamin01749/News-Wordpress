...
function colormag_footer_copyright() {
   ...
   $default_footer_value = sprintf( __( 'Copyright &copy; %1$s %2$s. All rights reserved.</br>Developed by <a href="https://www.facebook.com/ruhulamin.imran" target="_blank">Md.Ruhul Amin Raj</a>', 'colormag' ), date( 'Y' ), $site_link );
...
?>
   <div class="breaking-news">
      <strong class="breaking-news-latest"><?php _e( 'এই মাত্র পাওয়া:', 'colormag' ); ?></strong>
      <ul class="newsticker">
