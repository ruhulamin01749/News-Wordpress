 ...
 <?php if ( is_active_sidebar('colormag_advertisement_above_the_footer_sidebar') ) { ?>
   ...
   <div class="main-content-section clearfix">
      <div id="primary">
		 ...
		 <?php
		 if( is_active_sidebar( 'colormag_front_page_content_middle_2_left_section' ) || is_active_sidebar( 'colormag_front_page_content_middle_2_right_section' )) {
         ?>
            <div class="tg-one-half">
               <?php
               if ( !dynamic_sidebar( 'colormag_front_page_content_middle_2_left_section' ) ):
               endif;
               ?>
            </div>
            <div class="tg-one-half tg-one-half-last">
               <?php
               if ( !dynamic_sidebar( 'colormag_front_page_content_middle_2_right_section' ) ):
               endif;
               ?>
            </div>
         <div class="clearfix"></div>
